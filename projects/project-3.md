...
The current software design is built for the open-source version of SDVX, K-Shoot mania. Further designs will include persistent setting storage and increased compatability with b***** tools. SDVX application will also be attempted to be ported to Debian via wine.
